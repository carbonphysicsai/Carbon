...
- [ ] Hotkey↔submission binding test (Build_Out §17 opportunity — do it now)
...
**Pin to Carbon:** Disclosure policy is anti-gaming; Landscape later compounds only from Launch-Bar Model Cards, never free-path mocks.
