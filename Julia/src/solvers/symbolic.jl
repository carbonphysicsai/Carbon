...
module SymbolicBridge

using ModelingToolkit, Symbolics, JSON3, JSON
using Symbolics: @variables, @parameters, build_function

export json_to_loss_term, parse_pysr_json, loss_terms_to_jax
...
function json_to_loss_term(json_expr::Dict) -> ModelingToolkit.Equation
    ...
    @variables t x y z
    @parameters p[1:20]  # strategy parameters
