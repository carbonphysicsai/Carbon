...
## 2. Lean Scoring Formulas (Protocol)

### 2.1 Hard Gates — Steep Sigmoid (Differentiable Binary)
...
## 2.1 Physics Fidelity — Quadratic Barrier (Increasing Returns)
...
### 3.3 Phase 1B: Precomputed Generators (Reacting Flow, FSI, 6-DOF, CHT)
...
### 3.4 Stress Generator (Hidden, Fresh Every Eval)
...
### 5.1 PySR Configuration (Phase 0)
...
### 11.2.3 Validator Integration with SciML Client
...
### 11.4 Docker Compose for Local Development
...
# julia/start_server.jl
using HTTP, JSON3, Sockets
using DifferentialEquations, NeuralPDE
