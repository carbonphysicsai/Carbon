...
Wave **B**, ticket **B-E1** (`done`). Implemented and tested in the shipping candidate; bounded completion awaits accepted normal merge. B-E2 remains next, todo, and unstarted.
