...
**Purpose:** Connect contextual participant identity and authenticated requests, then prove localnet and real scientific integration.
...
Wave C retains C0 network foundation, C1 real scientific vertical, and C2 direct testnet integration. NET-5R repairs the isolated shielded-registration compatibility gap. C-EA0 specifies durable evidence capture, C-EA1 implements only its closed synthetic development profile, C-EP1 adds the private DEVELOPMENT Variant-A job-to-pack lifecycle, C-EP2 measures that path while modeling possible sharing offline, and C-EP3 acquires missing inputs and measures one detached public numerical component. C-DC1 through C-DC4 remain a separate private Research Concierge. All scientific/result authority stays with existing owners.
...
- [NET-3](../tickets/net_3.md): Candidate commitment and accepted fixture bridge [done]
- [C-REWARD](../tickets/c_reward.md): Bounded-linear development reward core [done]
...
- [C-05](../tickets/c_05.md): Real measurement and Score Pack [in_progress]
...
- [Wave C controlling board](https://github.com/carbonphysicsai/Carbon/blob/4235c778357b51b8b6dd1b629fa1339bd26936ad/.agent/WAVE_C.md)
- [Current wave register](https://github.com/carbonphysicsai/Carbon/blob/4235c778357b51b8b6dd1b629fa1339bd26936ad/.agent/WAVE.md)
- [NET-1 ticket](https://github.com/carbonphysicsai/Carbon/blob/4235c778357b51b8b6dd1b629fa1339bd26936ad/.agent/tickets/NET-1_chain_adapter.md)
