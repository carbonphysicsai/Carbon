...
| C0 NET foundation / `ChainAdapter` / authenticated transport | active; NET-5 selected | NET-1, NET-2, NET-3, C-REWARD, NET-4A, NET-4B | NET-1, NET-2, NET-3, C-REWARD, NET-4A, NET-4B | NET-1 through NET-4B merged with canonical tests; NET-5 runtime candidate and NET-6 remain unqualified; G2 requires actual runtime evidence |
