...
| C0/C1 Wave C handoff | NET-1 through NET-6 and C-REWARD merged in bounded scope; C-01/C-AUTH1/C-EA0 delivered offline under OWNER-C1-C2-BURGERS-01; NET-5R remains selected | All-burn localnet, node/publisher recovery, complete logical backup/restore, two standard-runtime shielded registrations and shared-winner row/epoch observed; recycled-UID identity remains unresolved after a plain SDK nonce-transition Stale rejection, so G2 remains NOT_READY; offline C1/C2 sequencing creates no public deployment, scientific qualification or eligibility authority |
