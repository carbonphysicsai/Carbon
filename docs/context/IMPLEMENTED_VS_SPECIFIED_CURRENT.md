...
| C0 NET foundation / `ChainAdapter` / authenticated transport | active; NET-4B selected | NET-1, NET-2, NET-3, C-REWARD, NET-4A | NET-1, NET-2, NET-3, C-REWARD, NET-4A | NET-1 through NET-4A merged with canonical tests; NET-4B candidate and later C0 deliveries remain unqualified |
