...
| C0/C1 Wave C handoff | NET-1 through NET-6 and C-REWARD merged in bounded scope; C-01 selected for offline engineering under OWNER-C1-C2-BURGERS-01 | All-burn localnet, node/publisher recovery and complete logical backup/restore observed; shielded miner registration unresolved; shared-winner runtime and G2 NOT_READY; offline C1/C2 sequencing creates no public deployment, scientific qualification or eligibility authority |
