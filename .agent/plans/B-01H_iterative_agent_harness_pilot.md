...
adapters, exact-current-interpreter binding for portable synthetic evidence,
the exact-ticket B-05 manifest, and focused CPU coverage.

The native Python 3.11.16 diagnostic reports 80 focused tests passing. Ruff
