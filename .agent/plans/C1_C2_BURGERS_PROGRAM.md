...
The owner supplied `Carbon_C1_C2_Burgers_Execution_Prompt.md`, SHA256
`e7608f4a1a0817ec58250b5c6a8b6a69db1995b1c526dc533cfc74be808aef8a`,
and `Carbon_Challenge_Authoring_Workbench_V1.zip`, SHA256
`40f1fd47d62dd2269f8e141e6bb398d03a403aa6eb3ac08750b49dd68018bcdc`.
The ZIP's 84-file artifact manifest was checked byte-for-byte before use. Its
domain-separated release digest is
...
and Burgers Dynamics V1 is
`sha256:4fa6828a38050bd34fd76019fa472bdcd141a7f788ac09103544e4de0ffcd716`.
The archive remains external and unmodified. Its 31 bundled tests pass with
Python 3.11.11. This verifies package integrity and bounded development behavior,
not scientific qualification or archive durability.

## Prospective sequence

Dependency-ready offline C1 and C2 contract engineering may proceed while G2 is
NOT_READY. This amends ordering only. It does not change any ticket-local DoD,
pass G2, authorize public-network activity, or permit real eligibility without
