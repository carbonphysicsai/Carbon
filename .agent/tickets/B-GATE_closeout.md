...
- [ ] Complete B-E4 only after its preregistered utility rule passes and its
      conditional-leakage decision finds no protected-realization shortcut;
      failed or indeterminate gauntlet evidence blocks closeout.
...
Flip a Challenge LIVE, activate a remote service, claim scientific/security/network/production qualification, or authorize Wave C by implication.
