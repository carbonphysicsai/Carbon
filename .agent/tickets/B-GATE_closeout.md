...
Integrate all Wave B fixture contracts, prove the authority boundaries, inventory unresolved human inputs, and produce the evidence required for a prospective Wave C decision.

## Definition of Done

- [x] Run the complete fixture chain from scientific contracts through
      manifest, compile, practice, receipts, TEST_ONLY staging/exact-ref
      retrieval, private compatibility projection, Dossier, and fail-closed
      qualification manifest.
- [x] Prove no accepted Strategy parameter is ignored and no undocumented semantics are required.
- [x] Prove every allowed training-data lever resolves to an exact registered
...
- [x] Prove structural-component names, pins, unit tests, and claimed
...
- [x] Prove every provisional learned-component role is Challenge-owned,
      closed, pin-bound, I/O-compatible, reconstructible, and incapable of
      authorizing arbitrary graphs or code. Component evidence cannot become an
      assembled-system qualification claim.
- [x] Prove integrated practice and official-shaped reconstruction consume the same Strategy/compiler/resolved-plan semantic identity while retaining separate data rights and result types.
- [x] Prove mock/practice, prior, scaffold, forecast, and structural-research
      records cannot enter official score or lifecycle. Prove B-07F's
      fixture-official result can exercise only the unchanged fixture path and
      cannot create LIVE, leaderboard, frontier, network, settlement, or
      scientific authority.
- [x] Prove fixture prior evidence cannot activate `BOOTSTRAP_PUBLIC` or
...
- [x] Prove the fixture ledger append and private
...
- [x] Prove protected-field, failure-class, reference, and infrastructure invariants across the integrated path.
- [x] Prove target, sampling, stress, practice, qualification, deployment,
      verification, and realized-evidence populations cannot be silently
      collapsed or relabeled.
- [x] Prove MMS or another verification result cannot activate LIVE by itself,
      satisfy target-population or physical-validation evidence, or become a
      product/context-of-use claim.
- [x] Prove product, customer, payment, qualification, novelty, information
      value, and Landscape fields cannot enter lean scientific scoring or
      official evidence eligibility.
- [x] Prove another PDE, regime, envelope, geometry/BC class, implementation, or
      environment cannot inherit Burgers or fixture reference authority.
- [x] Prove reference uncertainty, disagreement, non-applicability, numerical
      failure, and infrastructure failure cannot become candidate physics
      failure, a mandatory-gate result, or an invented zero.
- [x] Prove no candidate receives candidate-specific graded depth, stress mass,
      measurement depth, reference fidelity, threshold, or Score Pack evidence.
- [x] Prove pre-base quality forecasts, partial builds, proxies, and screens can
...
- [x] Require B-E1 to pass dependence-aware interval-coverage fixtures,
...
- [x] Prove B-07G exposes exactly the B-07S-ratified closed v2 research
...
- [x] Before any prospective Wave C authorization, verify that the canonical C
...
See `.agent/evidence/wave_b/b-gate.md` and `.agent/WAVE_B_REPORT.md`. The
ticket-local C/D contracts required above are present and remain
`future_reserved`; this closeout selects no Wave C ticket.
