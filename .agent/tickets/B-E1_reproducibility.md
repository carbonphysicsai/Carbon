...
- [x] Represent R0 exact artifact/configuration identity, R1 numerical comparison, and R2 decision comparison as separate results.
- [x] Define reconstruction × whole-case/trajectory evidence identities,
      ...
      represented.
- [x] Preserve reconstruction-by-case and reconstruction-by-stratum
...
- [x] Represent reference variability, primary/witness disagreement,
...
- [x] Treat component uncertainty budgets as diagnostics. Permit quadrature or
...
- [x] Represent a staged `ReconstructionEvidencePolicy` with static admission,
...
- [x] Represent resolved, unresolved/indeterminate, evidence-deferred,
...
- [x] Define typed contested-outcome plumbing without implementing frontier promotion.
- [x] Exercise cases where an exact or manufactured anchor is numerically
      ...
      anchor's exactness.
- [x] Inject all tolerances, sample sizes, and power criteria; missing values fail closed.
- [x] Add deterministic fixture, null/coverage/power, correlated-error,
