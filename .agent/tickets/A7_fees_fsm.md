...
- [ ] Idempotency: duplicate `strategy_hash + hotkey + challenge version` returns existing open `submission_id`
...
- [ ] Unit tests: happy path, idempotent resubmit, reject path, FAILED_INFRA ≠ physics fail, fee≠score, CANCELLED reachable/documented
