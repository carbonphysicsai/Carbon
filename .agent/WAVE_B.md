...
applicable acceptance and normal merge. Version 3.0 prepares B-07F bounded
`done` on accepted normal merge and leaves B-07G next, `todo`, and unstarted;
later composition and operation implementations remain absent.
