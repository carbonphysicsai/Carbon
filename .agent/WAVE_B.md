...
B-07D1/D2/D3 after applicable acceptance. Version 2.9 prepares B-07E bounded
`done` on accepted normal merge and leaves B-07F next, `todo`, and unstarted;
later operation implementations remain absent.
