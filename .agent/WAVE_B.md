...
| B-03 | Generator API and fixed-viscosity Burgers fixture implementation | in_progress | `.agent/evidence/wave_b/b-03.md` (PR #67 exact reviewed contract merge and exact-main CI complete; bounded runtime candidate in progress) | Codex + SciML | SciML + statistics + protocol | B-02A | MQ-002, MQ-003 | L | WB-1/2 |
