...
approval. B-01, B-01E, B-02A, B-07R, B-02B, and B-02C are authoritatively
`done` in their recorded bounded scopes. B-03 is the selected `in_progress`
ticket. Working engineering decisions
...
| B-03 | Generator API and fixed-viscosity Burgers fixture implementation | in_progress | `.agent/evidence/wave_b/b-03.md` (working-contract phase; runtime implementation begins only after exact contract merge and exact-main CI) | Codex + SciML | SciML + statistics + protocol | B-02A | MQ-002, MQ-003 | L | WB-1/2 |
