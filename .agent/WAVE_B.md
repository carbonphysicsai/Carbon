...
This Version-2.3 shipping snapshot ratifies B-07S conditionally as above;
B-07A is next, `todo`, and unstarted. Campaign-specific acquisition/result
...
merged snapshot completed B-E3 and selected B-07S. Version 2.3 conditionally
completes B-07S's exact protocol ratification and leaves B-07A next, `todo`,
and unstarted; it adds no B-07 runtime implementation.
