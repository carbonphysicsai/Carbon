...
| NET-4A | Nominal publication intents | in_progress | `.agent/evidence/wave_c/net-4a.md` | Codex + network/protocol engineering | Network/protocol + security | C-REWARD | MQ-054, MQ-056 | M | C0 |
...
505f08cde173eab197aa397a09536bb6bf576065. NET-4A is selected, not delivered.
Later tickets are unstarted; materialize them
before implementation. No later ticket is selected.

## 4. Acceptance and maturity

NET-4A follows `.agent/tickets/NET-4A_weight_intents.md`, OWNER-DX-03
...
After accepted NET-4A merge, NET-4B is the next dependency-ready ticket.
