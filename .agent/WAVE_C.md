...
| C-EA1 | Durable evidence archive | in_progress for private-alpha preparation; accepted synthetic scope remains done | `.agent/evidence/wave_c/c-ea1.md` | Codex + evidence architecture | Operations + data/security + scientific integration | C-EA0 + OWNER-C-EA1-SYNTHETIC-01 + OWNER-C1-BURGERS-ALPHA-01 | MQ-048, MQ-051 | L | C1 |
...
| C-08 | Authenticated miner MCP end to end | done in bounded DEVELOPMENT scope | `.agent/evidence/wave_c/c-08.md` (PR #167 accepted) | Codex + API/protocol engineering | Protocol + security + scientific integration | NET-2, C-07, A9 | MQ-051, MQ-054 | L | C1/C2 |
