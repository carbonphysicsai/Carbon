...
| C-05 | Real measurement and Score Pack | done in bounded public-candidate engineering scope; broader qualification open | `.agent/plans/C-05_measurement_runtime.md` | Scientific measurement engineering | Physics/SciML + statistics | B-05, C-04; C-02 bounded adapter capability is satisfied and broader closure is non-blocking | MQ-045, MQ-048 | L | C1 |
| C-06 | Signed evaluation receipt | in_progress for non-official DEVELOPMENT receipt | `.agent/plans/C-06_signed_development_evidence.md` | Scientific integration + receipt engineering | Security + Physics/SciML | C-01, C-02, C-04, C-05 | MQ-048, MQ-051 | L | C1 |
