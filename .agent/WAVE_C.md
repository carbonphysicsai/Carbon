...
| C-EP1 | DEVELOPMENT per-job evaluation packs | in_progress | `.agent/evidence/wave_c/c-ep1.md` | Codex + execution/scientific integration | Execution + scientific integration + data/security | NET-3, C-01, A4-A8 | MQ-048, MQ-051 | M | C1 development |
