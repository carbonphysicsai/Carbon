...
| A3 | C1 | Challenge registry + LIVE qualification **hash** gate | in_progress | Exact base `e6fb20b1dc361ded442fcf41d118cea5f2c775cd`; local evidence: 127 focused and 385 default CPU tests passed, strict changed-file Ruff/Black and no-new-debt gate passed, fresh no-dependency wheel passed outside-tree isolation; independent review/merge pending |
