...
| A8 | §5 | TrainEvalAPI **fixture stub** (structurally non-production/non-emission) | todo | Must satisfy current A8 ticket + `Build_Out_Constitutional_Overlay.md`; future ReconstructionProtocol remains out of A8 scope |
